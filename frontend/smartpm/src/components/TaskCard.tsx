...
export function TaskCard({ title, priority, priorityTrend = "stable", onClick }: TaskCardProps) {

    return (
        <div onClick={onClick} className="group relative bg-white/10 backdrop-blur-lg rounded-2xl p-5 border border-white/10 shadow-md hover:shadow-xl hover:shadow-purple-500/10 transition-all duration-300 hover:bg-white/20 hover:-translate-y-0.5 overflow-hidden cursor-pointer">
